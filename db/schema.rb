...
ActiveRecord::Schema[8.1].define(version: 2026_08_25_022000) do
  ...
  create_table "meal_items", force: :cascade do |t|
    ...
    t.index ["normalized_name"], name: "index_meal_items_on_normalized_name"
  end

  create_table "meal_requests", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "meal_id", null: false
    t.boolean "reused", default: false, null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["meal_id"], name: "index_meal_requests_on_meal_id"
    t.index ["user_id", "created_at"], name: "index_meal_requests_on_user_id_and_created_at"
    t.index ["user_id"], name: "index_meal_requests_on_user_id"
  end
  ...
  create_table "meals", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["image_checksum"], name: "index_meals_on_image_checksum", unique: true
  ...
  add_foreign_key "meal_requests", "meals"
  add_foreign_key "meal_requests", "users"
